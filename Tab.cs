...
public class Symbol {
    ...
    public enum TokenKind
    {
        ...
        LiteralToken        = 2, // e.g. "while"
        ClassLiteralToken   = 3  // e.g. letter {letter} but without literals that have the same structure
    }
	...
	public TokenKind tokenKind;   // t:  token kind (fixedToken, classToken, ...)
...
public class Tab {
	...
	void PrintSym(Symbol sym) {
		...
		if (sym.typ == Node.nt) {
			...
			trace.Write("            ");
		trace.WriteLine("{0,5} {1}", sym.line, tKind[(int)sym.tokenKind]);
	}
